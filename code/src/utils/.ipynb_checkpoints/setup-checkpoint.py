...
#     # bert_p = [n for n, p in model.bert.named_parameters()]
#     optimizer_grouped_parameters = [
#         {'params': [p for n, p in model.named_parameters() if not any(nd in n for nd in no_decay) and (not any(n_b in n for n_b in roberta))],
#          'weight_decay': args.weight_decay, 'lr': args.learning_rate},
#         {'params': [p for n, p in model.named_parameters() if not any(nd in n for nd in no_decay) and any(n_b in n for n_b in roberta)], 
#          'weight_decay': args.weight_decay, 'lr': args.bert_learning_rate},
#         {'params': [p for n, p in model.named_parameters() if any(nd in n for nd in no_decay) and (not any(n_b in n for n_b in roberta))], 
#          'weight_decay': 0.0, 'lr': args.learning_rate},
#         {'params': [p for n, p in model.named_parameters() if any(nd in n for nd in no_decay) and any(n_b in n for n_b in roberta)], 
